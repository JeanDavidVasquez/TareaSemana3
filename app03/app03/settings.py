...
SECRET_KEY = 'django-insecure-gfmja^kz1+07+5#t-g5atq&r#^9b#bh^+bk0r(6073=5z2j_tb'
...
INSTALLED_APPS = [
    'jazzmin',  # Optional: for enhanced admin interface
    ...
    'app03',  # Your application
    'applicacion',  # Assuming this is your app name
...
JAZZMIN_SETTINGS = {
    ...
    "site_icon": "books/img/favicon.ico",

    # Welcome text on the login screen
    "welcome_sign": "Welcome to the UTPL Library",

    # Copyright on the footer
    "copyright": "© 2025 UTPL Library",
